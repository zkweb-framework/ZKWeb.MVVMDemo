using System;
using ZKWeb.MVVMPlugins.MVVM.Common.SessionState.src.Domain.Entities.Extensions;
...
namespace ZKWeb.MVVMPlugins.MVVM.Common.SessionState.src.Domain.Services {
	/// <summary>
	/// 会话管理器
	/// </summary>
	...
	public class SessionManager : DomainServiceBase<Session, Guid> {
		...
		/// 用于在当前Http请求保存会话
		/// </summary>
		public const string SessionContextKey = "ZKWeb.Session";
