...
dotnet ../ZKWeb/Tools/WebsitePublisher.Cmd.NetCore/ZKWeb.Toolkits.WebsitePublisher.Cmd.dll -f netcoreapp2.0 -x ".*node_modules.*" -r "src/ZKWeb.MVVMDemo.AspNetCore" -n "ZKWeb.MVVMDemo.Ubuntu" -o "../ZKWeb.MVVMDemo.Publish"
